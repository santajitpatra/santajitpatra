...
const privacy = () => {
  return (
    <>
      ...
      <div className="p-16">
        <h2 className="text-center hading">Privacy Policy</h2>
        <p>
          <strong>Effective Date: 25-01-2023</strong>
        </p>
        <h3>Your privacy is important to us</h3>
        <p>Santajit patra is located at:</p>
        <address>
          Santajit patra
          <br />
          Amta Howrah <br />
          711401 West Bengal , India
          <br />
          9134504611
        </address>
        <p>
          It is Santajit patra's policy to respect your privacy regarding any
          ...
          (hereinafter, "us", "we", or "santajitpatra.netlify.app/"). We respect
        ...
        <ol type={1}>
          ...
          <li>
            <a href="#Remarketing">
              <strong>
                Santajit patra uses Google AdWords for remarketing
              </strong>
            </a>
          </li>
          <li>
        ...
        <p>
          Like most website operators, Santajit patra collects
          non-personally-identifying information of the sort that web browsers
          and servers typically make available, such as the browser type,
          language preference, referring site, and the date and time of each
          visitor request. Santajit patra's purpose in collecting non-personally
          identifying information is to better understand how Santajit patra's
          visitors use its website. From time to time, Santajit patra may
        ...
        <p>
          Santajit patra also collects potentially personally-identifying
          information like Internet Protocol (IP) addresses for logged in users
          and for users leaving comments on https://santajitpatra.netlify.app/
          blog posts. Santajit patra only discloses logged in user and commenter
        ...
        <p>
          Certain visitors to Santajit patra's websites choose to interact with
          Santajit patra in ways that require Santajit patra to gather
          personally-identifying information. The amount and type of information
          that Santajit patra gathers depends on the nature of the interaction.
          For example, we ask visitors who leave a comment at
          https://santajitpatra.netlify.app/ to provide a username and email
          address.
        </p>
        <p>
          <a href="#tableofcontents">Back to table of contents</a>
        ...
        <p>
          ...
          Santajit patra and does not cover the use of cookies by any
          advertisers.
        </p>
        <p>
          <a href="#tableofcontents">Back to table of contents</a>
        ...
        <h2 id="Remarketing">
          6. Santajit patra uses Google AdWords for remarketing
        </h2>
        <p>
          Santajit patra uses the remarketing services to advertise on third
        ...
        <p>
          Santajit patra discloses potentially personally-identifying and
          personally-identifying information only to those of its employees,
          contractors and affiliated organizations that (i) need to know that
          information in order to process it on Santajit patra's behalf or to
          provide services available at Santajit patra's website, and (ii) that
          ...
          your home country; by using Santajit patra's website, you consent to
          the transfer of such information to them. Santajit patra will not rent
          ...
          affiliated organizations, as described above, Santajit patra discloses
          ...
          governmental request, or when Santajit patra believes in good faith
          that disclosure is reasonably necessary to protect the property or
          rights of Santajit patra, third parties or the public at large.
        </p>
        <p>
          If you are a registered user of https://santajitpatra.netlify.app/ and
          have supplied your email address, Santajit patra may occasionally send
          you an email to tell you about new features, solicit your feedback, or
          just keep you up to date with what's going on with Santajit patra and
          ...
          other users. Santajit patra takes all measures reasonably necessary to
        ...
        <p>
          Santajit patra may collect statistics about the behavior of visitors
          to its website. Santajit patra may display this information publicly
          or provide it to others. However, Santajit patra does not disclose
          your personally-identifying information.
        </p>
        <p>
          <a href="#tableofcontents">Back to table of contents</a>
        </p>
        <h2 id="Affiliates">9. Affiliate Disclosure</h2>
        <p>
        ...
        <p>
          To enrich and perfect your online experience, Santajit patra uses
        ...
        <p>
          ...
          website each time the visitor returns. Santajit patra uses cookies to
          help Santajit patra identify and track visitors, their usage of
          https://santajitpatra.netlify.app/, and their website access
          preferences. Santajit patra visitors who do not wish to have cookies
          placed on their computers should set their browsers to refuse cookies
          before using Santajit patra's websites, with the drawback that certain
          features of Santajit patra's websites may not function properly
          without the aid of cookies.
        </p>
        <p>
          By continuing to navigate our website without changing your cookie
          settings, you hereby acknowledge and agree to Santajit patra's use of
          cookies.
        </p>
        <p>
          <a href="#tableofcontents">Back to table of contents</a>
        </p>
        <h2 id="Ecommerce">11. E-commerce</h2>
        <p>
          Those who engage in transactions with Santajit patra – by purchasing
          Santajit patra's services or products, are asked to provide additional
          ...
          Santajit patra collects such information only insofar as is necessary
          or appropriate to fulfill the purpose of the visitor's interaction
          with Santajit patra. Santajit patra does not disclose
        ...
        <h2 id="businesstransfers">12. Business Transfers</h2>
        <p>
          If Santajit patra, or substantially all of its assets, were acquired,
          or in the unlikely event that Santajit patra goes out of business or
          ...
          transfers may occur, and that any acquirer of Santajit patra may
        ...
        <p>
          Although most changes are likely to be minor, Santajit patra may
          change its Privacy Policy from time to time, and in Santajit patra's
          sole discretion. Santajit patra encourages visitors to frequently
        ...
        <p>
          ...
          us via <a href="mailto:business.santajitpatra@gmail.com">email</a> or{" "}
          <a href="tel:9134504611">phone</a>.
        </p>
        <p>
          <a href="#tableofcontents">Back to table of contents</a>
        </p>
