      ...
      <div className="relative xl:h-screen overflow-hidden bg-gradient-to-br from-cyan-300 to-blue-900">
        ...
        <div className="container relative z-10 flex items-center px-6 py-32 mx-auto md:px-12 xl:py-40">
          <div className="relative z-10 flex flex-col items-center w-full h-full">
            ...
            <Link
              href="/home"
              className="text-center text-lg text-white hover:text-yellow-50 bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 rounded-full mx-96 py-3 px-3 w-48"
            >
              Back To Homepage
            </Link>
          </div>
