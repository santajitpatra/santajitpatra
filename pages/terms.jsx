    ...
    <>
      ...
      <div className="p-16">
        ...
        <p>
          ...
          in full. Do not continue to use Santajit patra's website if you do not
        ...
        <h2>Cookies</h2>
        <p>
          We employ the use of cookies. By using Santajit patra's website you
          consent to the use of cookies in accordance with Santajit patra's
          privacy policy.
        </p>
        <p>
        ...
        <h2>License</h2>
        <p>
          Unless otherwise stated, Santajit patra and/or it's licensors own the
          intellectual property rights for all material on Santajit patra. All
          intellectual property rights are reserved. You may view and/or print
          pages from santajitpatra.netlify.app/ for your own personal use
          subject to restrictions set in these terms of service.
        </p>
        <p>You must not:</p>
        <ol>
          <li>Republish material from santajitpatra.netlify.app/</li>
          <li>
            Sell, rent or sub-license material from santajitpatra.netlify.app/
          </li>
          <li>
        ...
        <p>
          Redistribute content from Santajit patra (unless content is
        ...
        <ol>
          ...
          <li>
            ...
            ('Comments') in areas of the website. Santajit patra does not
            ...
            Santajit patra, its agents or affiliates. Comments reflect the view
            and opinion of the person who posts such view or opinion. To the
            extent permitted by applicable laws Santajit patra shall not be
          ...
          <li>
            Santajit patra reserves the right to monitor all Comments and to
          ...
          <li>
            You hereby grant to <strong>Santajit patra</strong> a non-exclusive
        ...
        <p>
          ...
          outweighs the absence of Santajit patra; and (d) where the link is in
        ...
        <p>
          ...
          <a
            ...
            title="send an email to business.santajitpatra@gmail.com"
          >
        ...
        <p>
          No use of Santajit patra's logo or other artwork will be allowed for
